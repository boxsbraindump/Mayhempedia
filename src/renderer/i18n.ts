...
const zh: Dict = {
  ...
  'overlay.standbyDesc': '进入 ARAM: Mayhem 选人后，我会锁定你的英雄，并显示本局路线、核心增强、陷阱增强和出装节奏。',
...
const en: Dict = {
  ...
  'overlay.standbyDesc': "Enter ARAM: Mayhem champ select and I'll lock onto your champion, showing this game's route, core augments, traps to avoid, and item order.",
